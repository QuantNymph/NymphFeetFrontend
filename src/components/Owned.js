...
function Owned({connection}) {
  ...
  return (
    <>
      ...
      {ownedBots.length > 0 && !isLoading && <div id="gallery">
        <div id="invite"><a href='https://discord.gg/AG5zAhBUCT'>Come to the discord!</a> (verify with collab.land for access)</div>
        {ownedBots.map(b => (
